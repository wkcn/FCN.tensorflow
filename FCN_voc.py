...
import read_voc as scene_parsing
import datetime
...
tf.flags.DEFINE_string("logs_dir", "logs_voc/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "Data_zoo/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/", "path to dataset")
